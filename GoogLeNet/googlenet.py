...
class Inception_block(nn.Module):
    ...
    def forward(self, x):
        ...
        return torch.cat([self.branch1(x), self_branch2(x), self_branch3(x), self_branch4(x)], 1) #concatenate along the 1 dimension (filters)
...
class conv_block(nn.Module):
    def __init__(self, in_channels, out_channels, **kwargs):
        ...
        self.batchnorm = nn.BathcNorm2d(out_channels)
